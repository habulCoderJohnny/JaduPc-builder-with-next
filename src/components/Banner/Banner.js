      ...
      <div className="flex flex-col md:flex-row  md:justify-between md:items-center w-full max-w-screen-xl mx-auto h-full  bg-white overflow-hidden md:gap-1 gap-4 p-0.5">
        <div className="max-w-lg">
          <div className="text-blue-light font-extrabold">
            ...
            <h1 className="lg:text-6xl sm:text-6xl xxs:text-5xl text-4xl leading-snug sm:mt-4 xxs:mt-2">
              JaduPc Online.
            </h1>
          </div>
          <p className="lg:mt-10  lg:mb-14 sm:mt-8 sm:mb-10 mt-6 mb-8 max-w-md font-medium  text-4xl">
            5,000 TK Computer to
            Change the WORLD.
          </p>
          <button
